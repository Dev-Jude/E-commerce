            ...
            <div class="heroarea-slider owl-carousel">
                ...
                <div class="item" style="background: url('<?php echo e(asset('assets/images/' . $slider->photo)); ?>')">
                    ...
                    <div class="row">
                        ...
                        <div class="layer-4">
                            <div class="right-img">
                            <img class="img-fluid full-img" src="<?php echo e(asset('assets/images/' . $slider->logo)); ?>" alt="">
                            </div>
                        </div>
                        </div>
                    </div>
                            ...
                            <div class="slider-item">
                                <div class="product-card">
                                    <div class="product-thumb">
                                        ...
                                        <div class="product-button-group"><a class="product-button wishlist_store" href="<?php echo e(route('user.wishlist.store',$popular_category_item->id)); ?>" title="<?php echo e(__('Wishlist')); ?>"><i class="icon-heart"></i></a>
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\test1\installable\installable\core\resources\views/front/themes/theme3.blade.php ENDPATH**/ ?>