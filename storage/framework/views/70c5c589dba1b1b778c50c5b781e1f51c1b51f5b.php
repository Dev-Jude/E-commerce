...
<form class="admin-form tab-form" action="<?php echo e(route('back.item.store')); ?>" method="POST"
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <!-- size select field  portion old code-->
                    <!-- <div class="form-group">
                        <label for="size"><?php echo e(__('Select Size')); ?> </label>
                        <select name="size" id="size" class="form-control" >
                            <?php $sizes = ['small', 'medium', 'large', 'larger'] ?>
                            <option value="" selected><?php echo e(__('Select Size')); ?></option>
    ...
    <input type="text" name="size" id="size" class="form-control" placeholder="<?php echo e(__('Enter Size')); ?>" value="<?php echo e(old('size')); ?>">
</div>
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\test1\installable\installable\core\resources\views/back/item/create.blade.php ENDPATH**/ ?>