                ...
                <div class="row">
                  <div class="col text-center">
                   ...
                   <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <img class="img-fluid" width="180" height="250" alt="Logo" src="<?php echo e(asset('assets/images/'.$value['photo'])); ?>">
...
<?php echo $__env->make('master.front', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\test1\installable\installable\core\resources\views/user/order/invoice.blade.php ENDPATH**/ ?>