                    ...
                    <div class="card-body">
                            <div class="row">
                                ...
                                <?php $__currentLoopData = $cart; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <img class="img-fluid mb-5 mh-70" width="180" alt="Logo" src="<?php echo e(asset('assets/images/'.$value['photo'])); ?>">
                                ...
                                <div class="gd-responsive-table">
                                    ...
                                    <thead>
                                        ...
                                        <th class="px-0 bg-transparent border-top-0">
                                            <span class="h6"><?php echo e(__('Size')); ?></span>
                                        </th>
                                        <th class="px-0 bg-transparent border-top-0">
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\FUTURELABS\Downloads\e-commerce\e-commerce\installable\installable\core\resources\views/back/order/invoice.blade.php ENDPATH**/ ?>