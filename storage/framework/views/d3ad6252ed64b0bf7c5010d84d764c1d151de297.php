...
<form class="admin-form" action="<?php echo e(route('back.affiliate.update',$item->id)); ?>" method="POST"
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="affiliate_link" class="form-control"
                            ...
                            value="<?php echo e($item->affiliate_link); ?>" >
                    </div>
...
<?php echo $__env->make('master.back', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\test1\installable\installable\core\resources\views/back/item/affiliate/edit.blade.php ENDPATH**/ ?>